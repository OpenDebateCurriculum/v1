...
**Policy debaters call it cross-examination, Public Forum debaters call it crossfire.**

Cross-examination represents 20% of every Policy/LD debate round and more than 20% of every Public Forum round. Judges make decisions based on cross-examination, especially if they are less experienced. Strong cross-ex skills can win rounds and establish your credibility.

Look for logical fallacies in your opponents' arguments and expose them through strategic questioning. Use both clarifying questions and leading questions to gather information and set up your arguments.
...
Don't hesitate to ask about things you don't understand:

- **Acronyms**: "What does that acronym stand for?"
- **Technical terms**: "Can you explain what you mean by...?"
- **Complex links**: "How exactly does X lead to Y?"

**Why this matters**: If there's something you don't understand, chances are the judge is fuzzy on it as well. If your opponents can't articulate their case clearly in cross-examination, they'll probably lose the ballot.
...
Look for these logical fallacies in opponent arguments and expose them through questioning:

### Slippery Slope
Small thing supposedly snowballs into large consequence:
- **Question**: "What evidence shows that X necessarily leads to Y?"

### Naturalistic Fallacy
Assuming what is equals what should be:
- **Question**: "Just because something happens naturally, does that make it right?"

### Loaded Question
Question contains assumptions that may not be true:
- **Example**: "Given that your plan destroys the economy, how can you say it's beneficial?"
- **Response**: "I don't concede that our plan destroys the economy."
